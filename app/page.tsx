...
const featuredBlogs = [
  {
    ...
    excerpt: 'How the pros mentally prepare for big games and how you can apply the same techniques.',
      ...
      <section className="relative h-[70vh] overflow-hidden border-b border-gray-800">
        ...
        <div className="container mx-auto h-full flex items-end py-12 px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">Elite Basketball Training by Chris Brickley</h1>
            <p className="text-lg text-gray-300 mb-6">
              Train with the techniques I use with the world's best basketball players. 
              Elevate your game with pro-level drills, workouts, and insights.
            </p>
            <Link 
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {featuredVideos.map((video) => (
              <div key={video.id} className="bg-gray-900 rounded-lg overflow-hidden group hover:bg-gray-800 transition">
