...
export default async function AboutPage() {
  ...
  const testimonials = [
    {
      quote: "Chris Brickley transformed my game. His attention to detail and innovative training methods took my skills to another level.",
      author: "NBA All-Star",
    ...
    {
      quote: "Working with Chris was a game-changer. His knowledge of the game and ability to develop talent is unmatched.",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-300 mb-8">
                Elite Basketball Trainer. Skills Coach to the NBA Elite. Creator of BlackOps Basketball.
              </p>
              ...
              <div className="flex gap-4">
                <Link href="/videos" className="bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-md font-medium transition">
                  Watch Training Videos
                </Link>
                <Link href="/contact" className="bg-gray-800 hover:bg-gray-700 text-white px-6 py-3 rounded-md font-medium transition">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-900 p-8 rounded-lg">
              ...
              <p className="text-gray-400">
                Focus on perfecting fundamental skills while developing advanced techniques that separate elite players from the rest.
              </p>
            </div>
            <div className="bg-gray-900 p-8 rounded-lg">
              <h3 className="text-xl font-bold mb-4">Mental Approach</h3>
              <p className="text-gray-400">
                Building mental toughness and basketball IQ to make better decisions under pressure and in critical game situations.
              </p>
            </div>
            <div className="bg-gray-900 p-8 rounded-lg">
              <h3 className="text-xl font-bold mb-4">Physical Conditioning</h3>
              <p className="text-gray-400">
                Custom conditioning programs designed to improve athleticism, prevent injuries, and maximize performance longevity.
              </p>
            </div>
          </div>
        </div>
            ...
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-gray-900 p-8 rounded-lg">
                <div className="relative mb-6">
                  <svg className="w-8 h-8 text-red-600 mb-4" fill="currentColor" viewBox="0 0 24 24">
